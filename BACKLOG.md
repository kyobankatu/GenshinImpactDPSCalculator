...
- **Completion:** typed incoming switch dispatch, three independent Conductive
  markers, five-second C6 cooldown, exact expiry/reactivation boundaries, Hold
  consumption, and snapshot rollback pass focused and full gates; two
  `RaidenParty` runs remain 1,275,070 damage / 60,718 DPS
...
- **Checkpoint:** Phase 3 is complete. Protocol v12 carries explicit action,
  observation, privileged-state, loadout, and capability revisions. Actor and
...
- **Checkpoint:** Phase 6 is complete. Content-addressed gzip JSONL shards and
  manifest-last atomic publication preserve full decision/revision provenance.
...
- **Human-seed campaign checkpoint (2026-08-25):** 58 candidates have been
  researched; 26 source-matched train scenarios are newly retained and 32 are
  rejected or blocked. The tracked catalog contains 50 sources, 48 seeds, and
  29 usable seeds (28 train, one validation, zero holdout). The latest batch
  retains Wanderer/Layla and Wanderer/Zhongli. Wanderer/Xiangling remains
  Energy-infeasible, while Wanderer/Mika exposes a profiler defect: capability
  profiling invokes Mika's unsupported, source-optional Burst instead of
  respecting tracked actions. Phase 15 remains

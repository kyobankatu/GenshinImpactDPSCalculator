...
public final class RotationSourceCatalogRegressionTest {
    ...
    private static void assertTrackedPilotCatalogRoundTrips() throws Exception {
        ...
        if (catalog.getSources().size() != 28 || catalog.getSeeds().size() != 28) {
            throw new AssertionError("Expected twenty-eight reviewed rotation sources and seeds");
        }
        ...
        assertEquals(18, catalog.getUsableSeeds(DatasetSplit.TRAIN).size(), "train seeds");

...
public final class RotationSourceCatalogRegressionTest {
    ...
    private static void assertTrackedPilotCatalogRoundTrips() throws Exception {
        ...
        if (catalog.getSources().size() != 99 || catalog.getSeeds().size() != 94) {
            throw new AssertionError("Expected ninety-nine sources and ninety-four seeds");
        }
        ...
        assertEquals(61, catalog.getUsableSeeds(DatasetSplit.TRAIN).size(), "train seeds");

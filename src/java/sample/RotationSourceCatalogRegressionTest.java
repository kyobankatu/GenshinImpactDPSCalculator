...
public final class RotationSourceCatalogRegressionTest {
    ...
    private static void assertTrackedPilotCatalogRoundTrips() throws Exception {
        ...
        if (catalog.getSources().size() != 20 || catalog.getSeeds().size() != 20) {
            throw new AssertionError("Expected twenty reviewed rotation sources and seeds");
        }
        ...
        assertEquals(11, catalog.getUsableSeeds(DatasetSplit.TRAIN).size(), "train seeds");

...
public final class RotationSourceCatalogRegressionTest {
    ...
    private static void assertTrackedPilotCatalogRoundTrips() throws Exception {
        ...
        if (catalog.getSources().size() != 19 || catalog.getSeeds().size() != 19) {
            throw new AssertionError("Expected nineteen reviewed rotation sources and seeds");
        }
        ...
        assertEquals(10, catalog.getUsableSeeds(DatasetSplit.TRAIN).size(), "train seeds");

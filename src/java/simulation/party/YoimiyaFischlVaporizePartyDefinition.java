...
/** Train-split Yoimiya, Xingqiu, Bennett, and Fischl scenario. */
public final class YoimiyaFischlVaporizePartyDefinition
        extends CuratedPartyDefinition {
    /** Creates the deterministic source-matched loadout scenario. */
    public YoimiyaFischlVaporizePartyDefinition() {
        super(
                "YoimiyaFischlVaporize",
                DatasetSplit.TRAIN,
                25.0,
                List.of(

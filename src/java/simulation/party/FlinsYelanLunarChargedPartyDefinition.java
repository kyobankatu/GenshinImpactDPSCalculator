...
/** Train-split Flins, Ineffa, Yelan, and Sucrose Lunar-Charged scenario. */
public final class FlinsYelanLunarChargedPartyDefinition
        extends CuratedPartyDefinition {
    /** Creates the deterministic source-matched loadout scenario. */
    public FlinsYelanLunarChargedPartyDefinition() {
        super(
                "FlinsYelanLunarCharged",
                DatasetSplit.TRAIN,
                25.0,
                List.of(

...
public class FlinsPartySimulation {
    public static void main(String[] args) {
        ...
        try {
            ...
            TotalOptimizationResult optimization = OptimizerPipeline.run(
                    FlinsPartySimulation::createSimulator,
                    FlinsPartySimulation::executeRotation,
                    optimizationTargets);
            ...
            sim.printReport();
            visualization.HtmlReportGenerator.generate("simulation_report_flins.html",
